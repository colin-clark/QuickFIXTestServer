package com.cep.darkstar.onramp.configuration.djnews;
...
public class ClientConfiguration {
	static Logger logger = Logger.getLogger("com.cep.darkstar.onramp.configuration.djnews.ClientConfiguration");
