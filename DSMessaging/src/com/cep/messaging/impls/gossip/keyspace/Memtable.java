...
import com.cep.messaging.impls.gossip.keyspace.iterator.AbstractColumnIterator;
import com.cep.messaging.impls.gossip.keyspace.iterator.IColumnIterator;
import com.cep.messaging.impls.gossip.keyspace.iterator.SimpleAbstractColumnIterator;
    ...
    */
    ...
    public void updateLiveRatio()
    {
        if (!MemoryMeter.isInitialized())
        {
            ...
            logger.warn("MemoryMeter uninitialized (jamm not specified as java agent); assuming liveRatio of 10.0.  " +
            		"Usually this means something has disabled jamm because you are using a buggy JRE; upgrade to the Sun JRE instead");
            cfs.liveRatio = 10.0;
            return;
        }
