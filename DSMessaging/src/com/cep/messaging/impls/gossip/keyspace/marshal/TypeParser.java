...
public class TypeParser
{
    ...
    {
        String className = compareWith.contains(".") ? compareWith : "com.cep.messaging.impls.gossip.keyspace.marshal." + compareWith;
        Class<? extends AbstractType> typeClass = GossipUtilities.<AbstractType>classForName(className, "abstract-type");
        try
        {
