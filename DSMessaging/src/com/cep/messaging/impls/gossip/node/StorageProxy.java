...
import com.cep.messaging.impls.gossip.keyspace.commands.IMutation;
import com.cep.messaging.impls.gossip.keyspace.commands.IndexScanCommand;
...
import com.cep.messaging.impls.gossip.net.CachingMessageProducer;
...
import com.cep.messaging.impls.gossip.service.DatacenterReadCallback;
...
import com.cep.messaging.impls.gossip.service.IResponseResolver;
import com.cep.messaging.impls.gossip.service.IWriteResponseHandler;
import com.cep.messaging.impls.gossip.service.RangeSliceResponseResolver;
import com.cep.messaging.impls.gossip.service.ReadCallback;
import com.cep.messaging.impls.gossip.service.RepairCallback;
import com.cep.messaging.impls.gossip.service.RowDigestResolver;
import com.cep.messaging.impls.gossip.service.RowRepairResolver;
import com.cep.messaging.impls.gossip.service.TruncateResponseHandler;
...
import com.cep.messaging.impls.gossip.transport.handlers.ReadVerbHandler;
...
public class StorageProxy implements StorageProxyMBean
{
    ...
    private static boolean hintedHandoffEnabled = NodeDescriptor.hintedHandoffEnabled();
    private static int maxHintWindow = NodeDescriptor.getMaxHintWindow();
    ...
    static
    {
        ...
        try
        {
            mbs.registerMBean(new StorageProxy(), new ObjectName("com.cep.messaging.impls.gossip.partitioning:type=StorageProxy"));
        }
        catch (Exception e)
        {
    ...
    */
    ...
    {
        final String localDataCenter = NodeDescriptor.getEndpointSnitch().getDatacenter(GossipUtilities.getLocalAddress());
    ...
    public static IWriteResponseHandler performWrite(IMutation mutation, ConsistencyLevel consistency_level, 
    		String localDataCenter, WritePerformer performer) 
    		throws UnavailableException, TimeoutException, IOException
    {
		...
		} catch (com.cep.messaging.impls.gossip.thrift.UnavailableException e) {
			e.printStackTrace();
		}
    ...
    throws IOException
    {
        ...
        for (Map.Entry<InetAddress, Collection<InetAddress>> entry : hintedEndpoints.asMap().entrySet())
        {
            ...
            String dc = NodeDescriptor.getEndpointSnitch().getDatacenter(destination);

            if (targets.size() == 1 && targets.iterator().next().equals(destination))
            {
                // unhinted writes
                if (destination.equals(GossipUtilities.getLocalAddress()))
                {
    ...
    private static InetAddress findSuitableEndpoint(String table, ByteBuffer key) throws UnavailableException
    {
        ...
        NodeDescriptor.getEndpointSnitch().sortByProximity(GossipUtilities.getLocalAddress(), endpoints);
    ...
    private static List<Row> fetchRows(List<ReadCommand> commands, ConsistencyLevel consistency_level) throws IOException, UnavailableException, TimeoutException
    {
        ...
        for (ReadCommand command: commands)
        {
            ...
            if (dataPoint.equals(GossipUtilities.getLocalAddress()))
            {
                if (logger.isDebugEnabled())
            ...
            {
                if (digestPoint.equals(GossipUtilities.getLocalAddress()))
                {
                    if (logger.isDebugEnabled())
    ...
    static class LocalReadRunnable extends WrappedRunnable
    {
        ...
        protected void runMayThrow() throws IOException
        {
            ...
            MessagingService.instance().addLatency(GossipUtilities.getLocalAddress(), System.currentTimeMillis() - start);
    ...
    */
    ...
    throws IOException, UnavailableException, TimeoutException
    {
        ...
        try
        {
            ...
            for (AbstractBounds range : ranges)
            {
                ...
                NodeDescriptor.getEndpointSnitch().sortByProximity(GossipUtilities.getLocalAddress(), liveEndpoints);

                if (consistency_level == ConsistencyLevel.ONE && !liveEndpoints.isEmpty() && liveEndpoints.get(0).equals(GossipUtilities.getLocalAddress()))
                {
                    if (logger.isDebugEnabled())
    ...
    {
        final String myVersion = NodeDescriptor.getDefsVersion().toString();
        ...
        {
            Message message = new Message(GossipUtilities.getLocalAddress(), 
                                          Verb.SCHEMA_CHECK, 
        ...
        try
        {
            ...
            latch.await(NodeDescriptor.getRpcTimeout(), TimeUnit.MILLISECONDS);
        }
    ...
    throws IOException, TimeoutException, UnavailableException
    {
        ...
        for (AbstractBounds range : ranges)
        {
            ...
            try {
				handler.assureSufficientLiveNodes();
			} catch (com.cep.messaging.impls.gossip.thrift.UnavailableException e1) {
				e1.printStackTrace();
			}
