...
import com.cep.messaging.impls.gossip.keyspace.commands.AddColumnFamily;
...
import com.cep.messaging.impls.gossip.keyspace.commands.DropColumnFamily;
import com.cep.messaging.impls.gossip.keyspace.commands.DropKeyspace;
...
import com.cep.messaging.impls.gossip.keyspace.commands.UpdateKeyspace;
...
import com.cep.messaging.impls.gossip.service.ClientState;
...
public class DarkStarMessagingServer implements DarkStarMessagingService.Iface
{
    private static Logger logger = LoggerFactory.getLogger(DarkStarMessagingServer.class);
    ...
    public DarkStarMessagingServer()
    {
        requestScheduler = NodeDescriptor.getRequestScheduler();
    }
    ...
    throws InvalidRequestException, com.cep.messaging.util.exception.UnavailableException, TimedOutException
    {
    ...
    throws InvalidRequestException, TimedOutException, com.cep.messaging.util.exception.UnavailableException
    {
    ...
    throws InvalidRequestException, UnavailableException, TimedOutException
    {
        ...
        for (Map.Entry<ByteBuffer, Map<String, List<Mutation>>> mutationEntry: mutation_map.entrySet())
        {
            ...
            for (Map.Entry<String, List<Mutation>> columnFamilyMutations : columnFamilyToMutations.entrySet())
            {
                ...
                {
                    try {
						event = new EventObject(new String(mutation.column_or_supercolumn.column.getValue()));
						if (logger.isDebugEnabled()) {
							logger.debug("This node has received Client Message " + event.toString());
						}
    ...
    public KsDef describe_keyspace(String table) throws NotFoundException, InvalidRequestException
    {
        ...
        KSMetaData ksm = NodeDescriptor.getTableDefinition(table);
        if (ksm == null)
            throw new NotFoundException();
    ...
    public List<KsDef> describe_keyspaces() throws TException, InvalidRequestException
    {
        ...
        Set<String> keyspaces = NodeDescriptor.getTables();
    ...
    {
        if (keyspace == null || !NodeDescriptor.getNonSystemTables().contains(keyspace))
    ...
    throws InvalidRequestException, SchemaDisagreementException, TException
    {
        ...
        try
        {
            ...
            return NodeDescriptor.getDefsVersion().toString();
        }
    ...
    throws InvalidRequestException, SchemaDisagreementException, TException
    {
        ...
        CFMetaData oldCfm = NodeDescriptor.getCFMetaData(CFMetaData.getId(cf_def.keyspace, cf_def.name));
        if (oldCfm == null)
	...
	public CqlResult execute_cql_query(ByteBuffer query, Compression compression)
			...
			com.cep.messaging.impls.gossip.thrift.UnavailableException,
