...
public class GuidGenerator {
	...
	public static ByteBuffer guidAsBytes() {
		...
		return ByteBuffer.wrap(GossipUtilities.threadLocalMD5Digest().digest(valueBeforeMD5.getBytes()));
	}
	...
	private static String convertToStandardFormat(String valueAfterMD5) {
		...
		StringBuilder sb = new StringBuilder();
		sb.append(raw.substring(0, 8)).append("-").append(raw.substring(8, 12))
				.append("-").append(raw.substring(12, 16)).append("-")
				.append(raw.substring(16, 20)).append("-")
