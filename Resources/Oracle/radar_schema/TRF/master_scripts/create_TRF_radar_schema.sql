...
CREATE INDEX EXCEPTION_BLOCK_IDX1 ON EXCEPTION_BLOCK (EXCEPTION_ID, EXCEPTION_TIMESTAMP, EXCEPTION_DATETIME)
/
...
CREATE INDEX EXCEPTION_BLOCK_DATA_IDX1 ON EXCEPTION_BLOCK_DATA 
    (EXCEPTION_ID, EXCEPTION_TIMESTAMP, COLUMN_SEQUENCE_NUMBER, EXCEPTION_TYPE_SCHEMA_ID)
/
